...
export const SettingsProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const [currentStyle, setCurrentStyle] = useState<VisualizerStyle>(() => {
    return (localStorage.getItem("pancake_current_style") as VisualizerStyle) || "standard";
  });

  // Save currentStyle to localStorage
  useEffect(() => {
    localStorage.setItem("pancake_current_style", currentStyle);
  }, [currentStyle]);
