...
const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose, onLegalClick }) => {
  const {
    settings,
          ...
          <div className="w-48 bg-black/20 border-r border-white/5 flex flex-col p-2 gap-1 flex-shrink-0">
            ...
            <div className="mt-auto pt-4 border-t border-white/5">
              <button
                ...
                className="flex items-center gap-3 w-full px-4 py-3 rounded-lg text-xs font-semibold text-gray-500 hover:bg-white/5 hover:text-white transition-all group"
              >
