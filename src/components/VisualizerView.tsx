...
const FpsCounter: React.FC<{ fps: number }> = React.memo(({ fps }) => (
  ...
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden">
      ...
      {currentTrack && (
        ...
        `}
        >
          <h2 className="text-4xl font-extrabold text-white text-glow mb-2 font-google-sans tracking-tight">
            {currentTrack.title}
          </h2>
          <p className="text-xl text-cyan-400/80 font-medium tracking-wide uppercase text-sm">
            {currentTrack.artist}
          </p>
        </div>
      )}
